...
- [ERP purchase-order sync scope](erp-po-import-sync.md) — user decision: sync ONLY /purchase-orders + /open-orders modules; never scan the 32k /orders list (a scan was built then rejected/removed July 2026).
