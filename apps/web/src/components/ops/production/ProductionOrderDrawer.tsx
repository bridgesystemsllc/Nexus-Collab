        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-5 py-4 space-y-5">
          ...
          <div className="border-t border-[var(--border-subtle)] pt-4">
            ...
            <div className="flex gap-2 mb-2">
              <input className={fieldClass} placeholder="Add a task…" value={newTask} onChange={(e) => setNewTask(e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter' && !e.nativeEvent.isComposing) { e.preventDefault(); addTask() } }} />
